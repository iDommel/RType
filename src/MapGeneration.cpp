...
namespace ecs
{
    ...
    void GameSystem::createEnemy(IScene &scene, Enemy::EnemyType mobId, int x, int y, QUuid id)
    {
        ...
        if (mobId == Enemy::EnemyType::SCOUT) {
            sprite = std::make_shared<Sprite>("assets/Enemies/RedEnemy1/RedEnemy1SS.png", 180.0f, 2.0f, origin);
            enemyComponent = std::make_shared<Enemy>(mobId, Missile::MissileType::E_CLASSIC, 8000);
            animation = std::make_shared<Animation2D>(10, 12, Animation2D::AnimationType::LOOP);
            ...
            sprite = std::make_shared<Sprite>("assets/Enemies/RedEnemy2/RedEnemy2SS.png", 180.0f, 2.0f, origin);
            animation = std::make_shared<Animation2D>(10, 12, Animation2D::AnimationType::LOOP);
            ...
            sprite = std::make_shared<Sprite>("assets/Enemies/RedEnemy3/RedEnemy3SS.png", 180.0f, 2.0f, origin);
            animation = std::make_shared<Animation2D>(10, 12, Animation2D::AnimationType::LOOP);
            ...
            sprite = std::make_shared<Sprite>("assets/Enemies/RedEnemy4/RedEnemy4SS.png", 180.0f, 2.0f, origin);
            animation = std::make_shared<Animation2D>(12, 12, Animation2D::AnimationType::LOOP);
